...
actually a design strategy (mobile-first), while the latter is the result of a technical approach (responsive). ... By doing so, they initially design a website for the smallest mobile devices possible and then scale upwards to adapt to desktop computers

What does font-size: 62.5% in the html tag do for us when using rem units?
it allows all browsers to be the same and have the same font-size
...
@media @phone and also parametric mixin and less because saves so much energy and it's more readable to everyone
